"""
# Navier-Stokes 3D Solver for Flow Around a Sphere with Multi-xPU Support
...
- Call the main function `navier_stokes_3d_multixpu(; do_save=true)` to run the simulation.
...
"""
    set_sphere_multixpu!(C, Vx, Vy, Vz, ox, oy, oz, lx, ly, lz, dx, dy, dz, r2)
